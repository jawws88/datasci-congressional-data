...
The [scipy installation page](https://www.scipy.org/install.html) provides excellent instructions for installing the above libraries on multiple different platforms, such as Linux, mac OS X and Windows. If you have any doubts or questions, refer to this guide, it has been followed by thousands of people.
...
My best advice is to Google search for your error message or post a question on [Stack Exchange](https://stackoverflow.com/questions/tagged/python).
